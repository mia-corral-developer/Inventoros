...
All endpoints (except login) require a Bearer token. Obtain one via `POST /api/v1/login`, then include it in the `Authorization` header:
...
All data is scoped to your organization. You can only access resources belonging to your organization.
